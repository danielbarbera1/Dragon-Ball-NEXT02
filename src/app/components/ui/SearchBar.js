  ...
  return (
    <div className="flex items-center gap-0 italic">
      <input 
        ...
        className="border-4 border-black px-4 py-2 font-black uppercase bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] outline-none focus:translate-x-1 focus:translate-y-1 focus:shadow-none transition-all w-64"
      />
